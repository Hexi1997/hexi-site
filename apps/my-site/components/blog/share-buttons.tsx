...
export function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  const handleShareTwitter = () => {
    const text = `New on WORLD3 Blog 🚀\n\n${title} #WORLD3 #AI #Web3\n\n${url}`;
      ...
      <div className="flex items-center gap-2">
        ...
        <Tooltip open={copyTooltipOpen || isCopied} onOpenChange={setCopyTooltipOpen}>
          <TooltipTrigger asChild>
            <div onClick={handleCopyLink} className="p-px cursor-pointer group rounded-[6px] bg-linear-to-b from-[#404040] to-[#171717] transition-colors hover:from-[#404040] hover:to-[#353535]">
              <div className="size-[26px] flex items-center justify-center rounded-[6px] bg-[#171717] group-hover:bg-[#353535] transition-colors text-[#d4d4d4] group-hover:text-[#f5f5f5]">
          ...
          <TooltipContent side="bottom" sideOffset={8} className="bg-[#262626] text-[#d4d4d4] text-sm  border border-[#404040]">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div onClick={handleShareTwitter} className="p-px cursor-pointer group rounded-[6px] bg-linear-to-b from-[#404040] to-[#171717] transition-colors hover:from-[#404040] hover:to-[#353535]">
              <div className="size-[26px] flex items-center justify-center rounded-[6px] bg-[#171717] group-hover:bg-[#353535] transition-colors text-[#d4d4d4] group-hover:text-[#f5f5f5]">
